...
define view entity zprad_C_BOOKING_PROCESSOR_M
  as projection on zprad_I_Booking_M
{
  ...
  key booking_id      as BookingID,
      ...
      _Travel         : redirected to parent zprad_C_TRAVEL_PROCESSOR_M,
      _BookSupplement : redirected to composition child zprad_C_BOOKSUPPL_PROCESSOR_M,
      _Customer,
      _Carrier
