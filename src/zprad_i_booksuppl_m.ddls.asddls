@AbapCatalog.sqlViewName: 'ZPRADIBOOKSUP_M'
...
define view zprad_I_BookSuppl_M 
  as select from /dmo/booksuppl_m as BookingSupplement

  association        to parent zprad_I_Booking_M  as _Booking     on  $projection.travel_id    = _Booking.travel_id
